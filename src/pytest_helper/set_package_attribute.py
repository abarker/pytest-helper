...
"""
# TODO: update the docs above (and elsewhere).
...
# NOTE: If you uncomment this line then this module works as a standalone
# module which only needs to be imported in a file.
